...
## FAQ
### Q: What's actually written in Rust?
...
This is an issue as Rust, admittedly, takes up some extra space. Right now, we just use a minimal ROM without any verification (except basic size checking) and no SPI code, allowing for running of custom images. In the future, if possible, we might be able to rewrite it in Rust.
